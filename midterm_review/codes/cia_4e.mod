...
//
//
// The material may be reproduced for educational and research purposes, 
// as long as the copies contain these notices and are retained for personal 
// use or distributed free.
//
// Acknowledge if used. No support is provided. // The codes are not 
// guaranteed error free. Comments/corrections welcom. 
//  
// walshc@ucsc.edu
//
// -----------------------
